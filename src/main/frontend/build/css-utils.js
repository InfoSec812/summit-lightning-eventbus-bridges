...
module.exports.purify = function(cb) {
  var css = glob.sync(path.join(__dirname, '../../resources/webroot/**/*.css'))
  var js = glob.sync(path.join(__dirname, '../../resources/webroot/**/*.js'))

  Promise.all(css.map(function (file) {
    return new Promise(function (resolve) {
      console.log('\n Purifying ' + path.relative(path.join(__dirname, '../../resources/webroot'), file).bold + '...')
